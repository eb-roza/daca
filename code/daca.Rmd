...
**Percent Approved: **Adding an additional dimension yields only a slight improvement in stress (`r stress_perc_approved3` when k = 3 and `rstress_perc_approved2` when k = 2).  Visually, we can see the distance relationships remain relatively steady.
